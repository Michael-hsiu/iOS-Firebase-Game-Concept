//
//  DungeonEntranceViewController.swift
//  Pokefinder App
//
...
class DungeonEntranceViewController: UIViewController {

    
    @IBAction func enterDungeon(_ sender: Any) {
        let dungeonVC = UIStoryboard(name: "Dungeons", bundle: nil).instantiateViewController(withIdentifier: "Dungeon") as! DungeonViewController
